...
namespace RadEndpoints.Cli.Helpers
{
    ...
    public static class RadHelper
    {
        public static MarkupTheme Theme => new MarkupTheme(
            Primary: new MarkupColor(Color.Aqua, "aqua"),
            Secondary: new MarkupColor(Color.Fuchsia, "fuchsia"),
        ...
        public static string AddHighlights(this string message)
        {
            ...
            foreach (var character in message)
            {
                ...
                string markupString = charString switch
                {
                    ...
                    _ when Regex.IsMatch(charString, @"\W") => $"[{theme.Secondary}]{charString}[/]",
                    _ when Regex.IsMatch(charString, @"\d") => $"[{theme.Highlight}]{charString}[/]",
